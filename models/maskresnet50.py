...
class MaskResnet50(nn.Module):
    def __init__(self, num_classes, rates, *args, **kwargs):
        super(MaskResnet50, self).__init__(*args, **kwargs)
    ...
    def init_weights(self):
        ...
        state_resnet50 = resnet50.features.state_dict()
        self.features.load_state_dict(resnet50)
...
if __name__ == '__main__':
    ...
    model = MaskResnet50(num_classes=21,
                            rates=[1,2,4,12] 
                )
